...
$(BUILD_DIR)/vm/agent.o: $(SRC_DIR)/vm/agent.c $(SRC_DIR)/vm/agent.h $(SRC_DIR)/vm/http.h $(SRC_DIR)/vm/value.h
$(BUILD_DIR)/vm/http.o: $(SRC_DIR)/vm/http.c $(SRC_DIR)/vm/http.h
